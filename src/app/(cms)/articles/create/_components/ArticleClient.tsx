...
import ArticleBasicInfo from "@/app/(cms)/articles/create/_components/ArticleBasicInfo";
import FeaturedImage from "@/app/(cms)/articles/create/_components/FeaturedImage";
import ArticleContent from "@/app/(cms)/articles/create/_components/ArticleContent";
import SeoContent from "@/app/(cms)/articles/create/_components/SeoSection";
import CategorySection from "@/app/(cms)/articles/create/_components/CategorySection";
import { CustomJwtPayload, userFromToken } from "@/lib/auth";
import { formSchema } from "@/app/(cms)/articles/create/schema";

export default function ArticleClient({ user }: { user: CustomJwtPayload }) {
